...
func (mr *MockapplicationMockRecorder) CreateUser(ctx, email, username, fullName, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) GetUsersByIDs(ctx, session, ids interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) ListUserAvatars(ctx, session interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) ListUserByFilters(ctx, arg1, filters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) RemoveAvatar(ctx, session, fileID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) UpdateUser(ctx, session, username, avatarID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockapplicationMockRecorder) UserByID(ctx, session, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
