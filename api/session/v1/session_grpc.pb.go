...
func (c *sessionInternalAPIClient) Save(ctx context.Context, in *SaveRequest, opts ...grpc.CallOption) (*SaveResponse, error) {
	...
	err := c.cc.Invoke(ctx, SessionInternalAPI_Save_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionInternalAPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, SessionInternalAPI_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionInternalAPIClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, SessionInternalAPI_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSessionInternalAPIServer should be embedded to have
...
func (UnimplementedSessionInternalAPIServer) testEmbeddedByValue() {}
...
func RegisterSessionInternalAPIServer(s grpc.ServiceRegistrar, srv SessionInternalAPIServer) {
	// If the following call pancis, it indicates UnimplementedSessionInternalAPIServer was
